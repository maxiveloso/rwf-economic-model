...
|-----------|-------|------|--------|
| MINCER_RETURN_HS | 0.058 | 2 | Mitra (2019) via Chen et al. (2022) - quantile ret... |
| EXPERIENCE_LINEAR | 0.00885 | 3 | PLFS 2023-24 cross-sectional age-wage profiles... |
| EXPERIENCE_QUAD | -0.000123 | 3 | PLFS 2023-24 cross-sectional age-wage profiles... |
| P_FORMAL_HIGHER_SECONDARY | 0.091 | 1 | ILO India Employment Report 2024 - 9.1% formal emp... |
| P_FORMAL_RTE | 0.3 | 1 | RWF assumption: 3.3× national baseline (Anand guid... |
| P_FORMAL_APPRENTICE | 0.68 | 1 | RWF placement data (validated Nov 2025)... |
| P_FORMAL_NO_TRAINING | 0.09 | 1 | PLFS aggregate estimates (derived, not directly qu... |
| REAL_WAGE_GROWTH_FORMAL | 0.015 | 2 | PLFS 2020-24 formal sector trends; India inequalit... |
| REAL_WAGE_GROWTH_INFORMAL | -0.002 | 2 | PLFS 2020-24 informal stagnation; India inequality... |
| SOCIAL_DISCOUNT_RATE | 0.05 | 2 | Murty & Panda (2020) - Ramsey formula p + vg = 8.5... |
| RTE_TEST_SCORE_GAIN | 0.137 | 1 | Muralidharan & Sundararaman (2013) NBER RCT w19441... |
| TEST_SCORE_TO_YEARS | 6.8 | 2 | Angrist & Evans (2020) micro-LAYS rescaling method... |
| APPRENTICE_INITIAL_PREMIUM | 78000 | 1 | Calculated: [(W_formal × P(F\App)) + (W_informal ×... |
| APPRENTICE_DECAY_HALFLIFE | 12 | 1 | Assumed - no India-specific data available... | Model assumption |
| APPRENTICE_COMPLETION_RATE | 0.85 | 1 | MSDE funnel analysis; independent of placement rat... |
| RTE_RETENTION_FUNNEL | 0.6 | 1 | UDISE+ EWS completion rates as proxy (no RTE-speci... |
