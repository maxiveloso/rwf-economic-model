...
|-----------|-------|------|--------|----------------------|
| MINCER_RETURN_HS | 0.07 | 2 | Mitra (2019) via Chen et al. (2022) - quantile ret... | Direct empirical |
...
| P_FORMAL_APPRENTICE | 0.72 | 1 | RWF placement data (validated Nov 2025)... | Direct empirical |
| P_FORMAL_NO_TRAINING | 0.1 | 1 | PLFS aggregate estimates (derived, not directly qu... | Direct empirical |
...
| APPRENTICE_INITIAL_PREMIUM | 84000 | 1 | Calculated: [(W_formal × P(F|App)) + (W_informal ×... | Direct empirical |
| APPRENTICE_DECAY_HALFLIFE | 10 | 1 | Assumed - no India-specific data available... | Model assumption |
...
- **P_FORMAL_APPRENTICE**: 0.72 (range: (0.5, 0.9))
- **P_FORMAL_NO_TRAINING**: 0.1 (range: (0.05, 0.15))
- **RTE_TEST_SCORE_GAIN**: 0.137 (range: (0.1, 0.2))
- **APPRENTICE_INITIAL_PREMIUM**: 84000 (range: (50000, 110000))
- **APPRENTICE_DECAY_HALFLIFE**: 10 (range: (5, 50))
