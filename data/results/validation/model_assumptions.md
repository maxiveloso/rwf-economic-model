...
|-----------|-------|------|--------|----------------------|
| MINCER_RETURN_HS | 0.058 | 2 | Chen et al. (2022) PLFS 2018-19 | Direct empirical |
...
| P_FORMAL_APPRENTICE | 0.68 | 1 | RWF placement data (validated Jan 2026)... | Direct empirical |
| P_FORMAL_NO_TRAINING | 0.09 | 1 | ILO India 2024 (derived) | Direct empirical |
...
| SOCIAL_DISCOUNT_RATE | 0.05 | 2 | Murty & Panda (2020) - Ramsey formula | Direct empirical |
...
- **RTE_TEST_SCORE_GAIN**: 0.137 (range: (0.1, 0.35))
